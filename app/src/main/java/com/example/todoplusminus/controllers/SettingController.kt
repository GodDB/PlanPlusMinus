...
import com.example.todoplusminus.bindingAdapter.setClickEventAndDim
...
class SettingController : DBControllerBase {
    ...
    private fun initSettingList() {
        binder.settingList.adapter = SettingListAdapter(mSettingVM, this)
    ...
    private fun showWarningDialog(){
        val delegate = object : CommonDialogController.Delegate{
        ...
        //todo 다국어
        val dialog = CommonDialogController(delegate, "정말 데이터를 \n모두 삭제하시겠습니까?")
    ...
    private fun showPlanSizeEditor() {
        val planSizeDelegate = object : PlanSizeEditorController.Delegate {
        ...
        val planSizeEditor = PlanSizeEditorController(planSizeDelegate)
